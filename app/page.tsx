...
export default async function Home({
  ...
  return (
    <div>
      ...
      >
        <FrameImage src="https://i0.wp.com/emotionull.art/wp-content/uploads/2022/01/LookinsideCover-1-1.png?w=1000&ssl=1" />
        {/* <FrameImage
        ...
        <FrameButton href={`https://emotionull.art/nftclaims/`}>Claim NFTS!</FrameButton>
      </FrameContainer>
    </div>
  );
}
